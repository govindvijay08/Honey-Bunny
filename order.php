            ...
            <form action="" method="POST" class="order">
                <fieldset>
                    ...
                    else
                    {
                        //image is available
                        ?>
                         <img src="<?php echo SITEURL ?>images/food/<?php echo $image_name; ?>" alt="Chicke Hawain Pizza" class="img-responsive img-curve" width="100px" height="50px">
                        <?php
                    }
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Govind Vijay" class="input-responsive" required>

                    <div class="order-label text-white">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 7982xxxxxx" class="input-responsive" required>

                    <div class="order-label text-white">Email</div>
                    <input type="email" name="email" placeholder="E.g. govindvijay08@gmail.com" class="input-responsive" required>
